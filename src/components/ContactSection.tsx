      ...
      <div className="px-6 relative z-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-luxury-black mb-3">
            Connect <span className="text-luxury-gold">With Us</span>
          </h2>
          ...
          <div className="bg-white p-6 shadow-md hover:shadow-lg transition-shadow rounded-lg flex items-center">
            ...
            <div className="flex-1">
              ...
              <a 
                ...
                className="text-luxury-gold hover:text-luxury-black transition-colors font-medium text-sm"
              >
                +123 456 7890
              </a>
            </div>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex justify-center gap-3">
            ...
            >
              ...
              <svg className="w-4 h-4 text-luxury-gold" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
